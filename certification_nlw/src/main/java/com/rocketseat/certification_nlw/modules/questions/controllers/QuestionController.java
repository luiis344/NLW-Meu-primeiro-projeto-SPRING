...
import com.rocketseat.certification_nlw.modules.questions.dto.AlternativesResultsDTO;
...
public class QuestionController {
    ...
    static QuestionResultDTO mapQuestionToDTO(QuestionEntity question) {
       ...
       List<AlternativesResultsDTO> alternativesResultsDTOS =
    ...
    static AlternativesResultsDTO mapAlternativeDTO(AlternativesEntity alternativesResultsDTO){
        return AlternativesResultsDTO.builder()
                .id(alternativesResultsDTO.getId())
                .description(alternativesResultsDTO.getDescription()).build();
